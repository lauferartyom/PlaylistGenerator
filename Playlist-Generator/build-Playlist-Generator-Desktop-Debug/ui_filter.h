...
public:
    ...
    void setupUi(QDialog *Filter)
    {
        ...
        checkBox = new QCheckBox(Filter);
        checkBox->setObjectName("checkBox");
        checkBox->setGeometry(QRect(60, 80, 83, 21));
        checkBox_2 = new QCheckBox(Filter);
        checkBox_2->setObjectName("checkBox_2");
        checkBox_2->setGeometry(QRect(60, 160, 83, 21));
        checkBox_3 = new QCheckBox(Filter);
        checkBox_3->setObjectName("checkBox_3");
        checkBox_3->setGeometry(QRect(60, 240, 83, 21));
    ...
    void retranslateUi(QDialog *Filter)
    {
        ...
        checkBox->setText(QCoreApplication::translate("Filter", "keyword", nullptr));
        checkBox_2->setText(QCoreApplication::translate("Filter", "artist", nullptr));
        checkBox_3->setText(QCoreApplication::translate("Filter", "genre", nullptr));
    } // retranslateUi
